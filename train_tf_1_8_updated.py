...
tf.app.flags.DEFINE_string("positive_data_file", "./data/rt-polaritydata/rt-polarity.pos", "Data source for the positive data.")
tf.app.flags.DEFINE_string("negative_data_file", "./data/rt-polaritydata/rt-polarity.neg", "Data source for the negative data.")

# Model Hyperparameters
tf.app.flags.DEFINE_integer("embedding_dim", 256, "Dimensionality of character embedding (default: 128)")
...
# Load data
print("Loading data...")
X = data_helpers.load_data_and_labels(FLAGS.positive_data_file, FLAGS.negative_data_file)
x_text = X[0]
y = X[1]
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        tf.summary.histogram("accuracy", cnn.accuracy)
